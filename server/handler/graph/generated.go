...
//go:embed "resolver/query.graphql" "resolver/user.graphql"
...
func (ec *executionContext) _Query_user(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOUser2ᚖkakeiboᚑwebᚑserverᚋdomainᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOUser2ᚖkakeiboᚑwebᚑserverᚋdomainᚐUser(ctx context.Context, sel ast.SelectionSet, v *domain.User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
